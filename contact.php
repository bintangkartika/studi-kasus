                ...
                <div class="row">
                    ...
                    <div class="col-md-5 ml-auto">
                        <div class="p-4 border mb-3">
                            <span class="d-block text-primary h6 text-uppercase">Badung</span>
                            <p class="mb-0">Kuta, Badung</p>
                        </div>
                        <div class="p-4 border mb-3">
                            <span class="d-block text-primary h6 text-uppercase">Gianyar</span>
                            <p class="mb-0">Mas Ubud, Gianyar</p>
                        </div>
                        <div class="p-4 border mb-3">
                            <span class="d-block text-primary h6 text-uppercase">Denpasar</span>
                            <p class="mb-0">Sanur, Denpasar</p>
                        </div>
                    </div>
                </div>
            </div>
